# =============================================================================
# Board : FireBeetle 2 ESP32-E  (Reference constants – copy values into common_const)
# RGB   : Onboard WS2812 NeoPixel on GPIO2 (per working guide)
# =============================================================================
...
# Onboard NeoPixel
USE_NEOPIXEL         = True
NEOPIXEL_PIN         = const(2)      # ✅ FireBeetle guide: GPIO2
...
# Discrete RGB fallback (not normally used on FireBeetle 2)
