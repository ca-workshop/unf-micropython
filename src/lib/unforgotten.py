...
class BLEScale:
    ...
    def __init__(self, name="ESP32S3"):
        ...
        # ─────────────────────────────────────────────────────────────
        self.led_blue = Pin(BLUE_LED_PIN, Pin.OUT)   # Connection / advertising
        self.led_green = Pin(GREEN_LED_PIN, Pin.OUT) # Weight above threshold
        self.led_red = Pin(RED_LED_PIN, Pin.OUT)     # Error / "no load" blink
